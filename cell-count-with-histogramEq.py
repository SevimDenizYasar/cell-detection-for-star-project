...
opening = cv2.morphologyEx(mask_blue, cv2.MORPH_OPEN, kernel2, iterations = 3)
...
cv2.drawContours(image=img_final, contours=contours, contourIdx=-1, color=(0, 255, 0), thickness=1, lineType=cv2.LINE_AA)
